...
provisioner "remote-exec" {
        inline  = [
			...
			"sudo git clone https://github.com/hchandel1012/Webrepo.git  /var/www/html/",
...
provisioner "local-exec" {
        command     = "git clone https://github.com/hchandel1012/Webrepo.git webserver-image"
    }
}
...
resource "aws_s3_bucket_object" "image-upload" {
    ...
    key     = "myphoto.jpeg"
    source  = "webserver-image/linux.png"
    acl     = "public-read"
}
